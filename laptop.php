               ...
               <div class="main">
                  ...
                  <form action="" method="post">
                     <div class="input-group">
                        <input type="text" class="form-control" name="search" placeholder="Temukan Gear Terbaikmu" auto>
               ...
               <div class="header_box">
                  <div class="lang_box ">
                     <a href="#" title="Language" class="nav-link" data-toggle="dropdown" aria-expanded="true">
                        <img src="images/indo.png" alt="flag" class="mr-2 " title="Indonesia" width="20px"> Indonesia <i class="fa fa-angle-down ml-2" aria-hidden="true"></i>
                     </a>
            ...
            <div class="col-md-3 col-sm-6">
               <figure class="card card-product-grid">
                  <a href="#" class="img-wrap">
                     <img src="images/laptop/<?php echo $row["img"]; ?>" width="300">
                  </a>
                  <figcaption class="info-wrap">
                     ...
                     <div class="mt-2">
                        ...
                        <a href="detail.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-outline-primary float-right"> Beli <i class="fa fa-shopping-cart"></i></a>
                     </div> <!-- action-wrap.end -->
                  </figcaption>
               </figure> <!-- card // -->
            </div> <!-- col.// -->
